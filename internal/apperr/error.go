...
const (
	...
	ErrMissingPathAction   = "error.missing_path_action"
	ErrInvalidPathAction   = "error.invalid_path_action"
	ErrPathUnsupported     = "error.path_unsupported"
	ErrPathExecutable      = "error.path_executable"
	ErrPathUpdate          = "error.path_update"
